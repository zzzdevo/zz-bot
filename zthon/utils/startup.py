    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊سەرچاوەی زیرەك بە سەرکەوتوویی دەستی پێکرد🧸♥️**",
                buttons=[(Button.url("ıQ𓅛", "https://t.me/MGIMT"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "IQ")
            await asyncio.sleep(3)
            await bot.send_message("@BotFather", "/setname")
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"یارمەتیدەری - {bot.me.first_name} ")
            await asyncio.sleep(3)
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بۆتی زیرەكی یارمەتیدەر ♥️🦾 تایبەت بە  {bot.me.first_name} ")
            await asyncio.sleep(3)
